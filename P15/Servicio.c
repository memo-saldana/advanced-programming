...
DWORD WINAPI corre(LPVOID lpParameter) {
	...
	while(TRUE) {
	char dirStr[]="C:\\Users\\Memo\ Saldana\\Github\\advanced-programming\\tmp";
	char dirFileStr[]="C:\\Users\\Memo\ Saldana\\Github\\advanced-programming\\tmp\\arch1.txt";
	char dirFileStr2[]="C:\\Users\\Memo\ Saldana\\Github\\advanced-programming\\tmp\\arch2.txt";
